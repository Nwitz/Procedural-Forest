...
Tree1::Tree1(const Shader& shader, Object& cubeObject) : ComplexModel(shader)
{
	...
	float offset = 15.0f; // used to center objects 
	...
	translation = glm::vec3(0.0f, offset, 2.5f);
	...
	translation = glm::vec3(-2.5f, offset, 0.0f);
	...
	translation = glm::vec3(8.0f, offset + 16.0f, 0.0f);
