...
Tree2::Tree2(const Shader& shader, Object& cubeObject) : ComplexModel(shader)
{
	...
	translation = glm::vec3(0.0f, -3.0f, 0.0f);
	...
	translation = glm::vec3(0.0f, 9.0f, 0.0f);
	...
	translation = glm::vec3(0.0f, 13.0f, 0.0f);
	...
	translation = glm::vec3(0.0f, 17.0f, 0.0f);
	...
	translation = glm::vec3(0.0f, 21.0f, 0.0f);
