...
const char* getFragmentShaderSource()
{
    return
				...
				"void main()"
                "{"
                "   FragColor = vec4((vertexNormal + vec3(1.0, 1.0, 1.0)) / 2, 1.0);" //TODO 2 Use the normals as fragment colors
                "}";
}
...
{
	vector<unsigned int> vertexIndices; //The contiguous sets of three indices of vertices, normals and UVs, used to make a triangle
...
#else
	string cubePath = "res/Models/cube.obj";
